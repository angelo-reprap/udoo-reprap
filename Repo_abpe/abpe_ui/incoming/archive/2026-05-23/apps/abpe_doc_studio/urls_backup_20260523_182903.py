...
api_patterns = [
    ...
    path('templates/<int:pk>/blocks/reorder/',
         api.TemplateBlockReorderAPI.as_view(),      name='api_template_block_reorder'),
    path('templates/<int:pk>/blocks/<int:tb_pk>/',
         api.TemplateBlockInlineUpdateAPI.as_view(),  name='api_template_block_update'),
