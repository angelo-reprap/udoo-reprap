...
""",
            ...
            # 2. Willkommens-Mail an neuen User
            try:
                send_mail(
...
Erste Schritte:
  1. Melden Sie sich an: https://abpe.win.abcona.info/login/
  2. Vervollständigen Sie Ihr Profil (oben rechts → Profil)
  3. Passen Sie Ihre Einstellungen an (Sprache, Theme)

Bei Fragen wenden Sie sich an: cv_scan@abcona.de
