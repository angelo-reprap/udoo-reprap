...
class DocAssembler:
    ...
    def _build_docx(self, tpl, all_vars: dict) -> DocxDocument:
        """
        DOCX aufbauen.
        LOGO-Block (order=10) erstellt 2-spaltige Tabelle.
        DOC_TITLE + PARTY_BLOCK (order 20-40) → linke Zelle.
    ...
    def _apply_header(self, doc: DocxDocument, layout) -> None:
        """
        Word-Header: nur Seitennummer.
        Format aus layout.page_number_format.
        Stil aus StyleDefinition 'footer_text'.
        """
        ...
        for section in doc.sections:
            ...
            p_nr.paragraph_format.space_after  = Pt(0)
            ...
            self._add_border_line(p_nr, COLOR_BRAND)
    ...
    def _apply_footer(self, doc: DocxDocument,
        ...
        for section in doc.sections:
            ...
            self._add_border_line(para, COLOR_BRAND, side='top')
    ...
    def _render_logo(self, doc, variables: dict, sk) -> None:
        ...
        # Spaltenbreiten: 9cm links, 6cm rechts (aus 15cm content)
        left_dxa  = int(9.0 * 567)
        right_dxa = int(6.0 * 567)
    ...
    def _render_signature(self, doc, content: str,
        ...
        for ri, line in enumerate(lines):
            ...
            for ci, (w, text) in enumerate([
                ...
                if ri == 0 and ci != 1:
                    self._add_border_line(p, COLOR_SIG_LINE)
    ...
    def _render_separator(self, doc) -> None:
        ...
        self._add_border_line(p, COLOR_SEPARATOR)
