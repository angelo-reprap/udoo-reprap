...
class BlockType(models.TextChoices):
    """
    10 OOXML-Grundbausteine — direkte Abbildung auf WordprocessingML-Elemente.
    Kein Template-spezifischer Typ mehr — alles generisch.
    """
    ...
    PAGE_BREAK      = 'PAGE_BREAK',      'Seitenumbruch <w:br>'
