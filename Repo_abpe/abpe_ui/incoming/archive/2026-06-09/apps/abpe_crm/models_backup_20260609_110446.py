...
# ============================================================
# 11. CrmContactPhone  (NEU — unbegrenzt viele Telefonnummern)
# ============================================================
...
class CrmContactPhone(models.Model):
    ...
    contact  = models.ForeignKey(CrmContact, on_delete=models.CASCADE,
                 related_name='phones', to_field='crm_id')
    typ      = models.CharField(max_length=20, choices=TYP_CHOICES, default='mobil')
