...
def _load_es_i18n(lang):
    ...
    import json, pathlib
    p = pathlib.Path(f'apps/abpe_ui/static/abpe_ui/i18n/{lang}/modules/email_studio.json')
    if not p.exists():
        p = pathlib.Path('apps/abpe_ui/static/abpe_ui/i18n/de/modules/email_studio.json')
    try:
