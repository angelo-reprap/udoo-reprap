...
Ablauf:
  ...
  2. extracted_json_export im RAM via main_translator_to_en uebersetzen
...
class MainGenerateEnHtmlTask:
    ...
    def run(self, consultant_id: int) -> dict:
        ...
        try:
            from apps.cv_extractor.services.main_translator_to_en import main_translator_to_en
            ...
            en_pre_json = main_translator_to_en.translate_pre_json(pre_json)
...
main_generate_en_html_task = MainGenerateEnHtmlTask()
