"""
main_translator_to_de.py
Prompt DB-Stage: main_translate_to_de
...
Singleton: main_translator_to_de
"""
import json
import logging
            ...
            if isinstance(value, list):
                ...
                for i in value:
                    if isinstance(i, dict) and 'name' in i:
                        ...
                        new_i = i.copy()
                        new_i['name'] = _translate_to_de(new_i['name'], context) if new_i['name'] else new_i['name']
                        processed.append(new_i)
                    else:
                        processed.append(_translate_to_de(str(i), context))
...
main_translator_to_de = MainTranslatorToDe()
