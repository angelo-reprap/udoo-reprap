...
WIZARD_PROMPT_DEFAULTS = [
    ...
    # ── Matching Neue Anfrage (E-Mail → Formular) ─────────────────────────────
    {
        ...
        'system': (
            ...
            '15. ansprechpartner.name NIEMALS mit dem Firmennamen füllen '
            '(nicht „a2a Experts“ als Person). Wenn nur Firma+E-Mail bekannt: '
            'name=null, email setzen — Personennamen ggf. aus E-Mail-Lokalteil ableiten lassen.\n'
            '\n'
