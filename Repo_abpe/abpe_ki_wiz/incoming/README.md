...
## Matching KI-Anfragen-Wizard

| Methode | URL | Body |
|---------|-----|------|
| POST | `/ki-wizard/api/matching-anfrage/extract/` | `{"email_text":"…","subject":"…","outer_from":"…"}` |

- Wizard-ID: `matching_anfrage`
- Prompt-Key (DB): `wiz_matching_anfrage_generate` — `manage.py sync_wizard_prompts --wizard-id matching_anfrage`
- UI: Matching → Button **KI-Anfragen-Wizard** links neben „+ Neue Anfrage“
- SYNC: `bash scripts/SYNC-matching-ki-anfrage-wizard.sh`
