...
def execute_job(self, job_id):
    ...
    # WICHTIG: ein Retry-Versuch (via apply_async countdown) landet bei genau demselben
    # (job, scheduled_for)-Paar wie der ursprungliche Run -- get_or_create findet ihn also
    # als 'nicht neu erstellt' und darf NICHT einfach abbrechen, sonst bleibt der Job fuer
    # immer in PENDING haengen. Nur abbrechen, wenn der bestehende Run tatsaechlich noch
    # RUNNING ist (= eine andere, parallele Ausfuehrung laeuft gerade wirklich).
