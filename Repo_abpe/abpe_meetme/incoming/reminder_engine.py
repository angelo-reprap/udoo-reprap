...
def reschedule_meeting(meeting, new_start_at):
    ...
    # Automatische Change-Notice-Erzeugung entfernt (Merge Schritt B):
    # der Versand an Gaeste laeuft jetzt explizit ueber das
    # vereinheitlichte Verschieben/Absagen-Modal (api_guest_send_adhoc /
    # api_meeting_notify_bulk), sonst wuerden Gaeste doppelt angeschrieben.
    sync_reminder_deliveries(meeting)

    return {
        'change_notice_count': 0,
