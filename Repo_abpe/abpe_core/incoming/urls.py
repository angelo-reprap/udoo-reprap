...
urlpatterns = [
    ...
    # ABpE CRM
    path('crm/', include('apps.abpe_crm.urls', namespace='abpe_crm')),
    path('scheduler/', include('apps.abpe_scheduler.urls')),
    path('meetme/', include('apps.abpe_meetme.urls', namespace='abpe_meetme')),


    # ABpE EDMS - API (JSON); die HTML-Seiten kommen über abpe_crm
