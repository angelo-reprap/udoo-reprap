# Gulp-Batch Review gulp-batch-20260820-221239

Quelle: `/tmp/gulp-batch-20260820-221239/result.tsv`
DB-TXT: `/tmp/gulp-batch-20260820-221239/source-txt`
Kopiert: 1 Einträge
...
|--------|------------|------------|------------|
| FAIL | `bbb/beemers_heiko` | convert | ja |
