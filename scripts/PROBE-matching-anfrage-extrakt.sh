...
#   bash <(git show origin/cursor/matching-ki-anfrage-wizard-7f07:scripts/PROBE-matching-anfrage-extrakt.sh)
#
# Optional:
...
#   USE_DB_PROMPT=1   # Prompt aus WizardPrompt (nach sync_wizard_prompts)
set -u
