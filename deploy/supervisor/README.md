...
```bash
cd /mnt/public/udoo-reprap && git fetch origin cursor/posteingang-index-3min-7f07
bash <(git show origin/cursor/posteingang-index-3min-7f07:scripts/ENSURE-abpe-scheduler-loop.sh)
