...
urlpatterns = [
    ...
    path('api/notify-preview/', views.api_notify_preview, name='api_notify_preview'),
    ...
    path('api/meetings/<int:meeting_id>/reminder-send-now/', views.api_reminder_send_now, name='api_reminder_send_now'),
    ...
    # Anhaenge (EDMS-Suche + Live-Ordner-Browser)
    path('api/attachments/search/', views.api_attachment_search, name='api_attachment_search'),
    path('api/attachments/browse/', views.api_attachment_browse, name='api_attachment_browse'),
]
